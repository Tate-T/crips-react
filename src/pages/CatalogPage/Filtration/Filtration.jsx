...
import { getBrands } from "../../../redux/products/selectors.js";
...
export const Filtration = () => {
	...
	const changeDressLength = (e) => {
		...
		setDressLength((prev) => (e.target.checked ? [...prev, length] : prev.filter((l) => l !== length)));
	};
	...
	const deleteDressSize = useCallback(
		(dressSizeToDelete) => {
	...
	return (
		<>
			<button className="catalog-filtration__phone-button" onClick={phoneButtonClick}>
				Filtration
			...
			<section className="filtration">
				<div className={`catalog-filtration__wrap ${isFilterApplied ? "" : "is-hidden"}`}>
					<div className="filtration-text__wrap">
						...
						<p className="filtration-text__reset" onClick={resetAll}>
							<img src={close} alt="" className="filtration-close" /> RESET ALL
						</p>
					</div>
					<ul>
						...
						<li className={(filtration.size || "") === "" ? "is-hidden" : ""}>
							...
							<div className="filtration-list__size">
								...
								<p key={filtration.size} className="selected-filters">
									{filtration.size}
								</p>
							</div>
						</li>
						...
						<li className={(filtration.price?.from === 0 || !filtration.price?.from) && (filtration.price?.to === 500 || !filtration.price?.to) ? "is-hidden" : ""}>
							...
							<div className="filtration-list__size">
								...
								<p className="selected-filters">
									{filtration.price?.from === filtration.price?.to ? `${filtration.price?.from},00 EUR` : `${filtration.price?.from},00 EUR - ${filtration.price?.to},00 EUR`}
								</p>
							</div>
						</li>
					</ul>
				...
				<div className="catalog-filtration__brand">
					...
					<form action="" className="catalog-filtration__brand-form">
						<div className="catalog-filtration__brand-input-wrap">
							<input type="checkbox" className="catalog-filtration__brand-input" value="State" onChange={changeBrand} />
							<p className="catalog-filtration__brand-input-name">State</p>
						</div>
						<div className="catalog-filtration__brand-input-wrap">
							<input type="checkbox" className="catalog-filtration__brand-input" value="Cooper" onChange={changeBrand} />
							<p className="catalog-filtration__brand-input-name">Cooper</p>
						</div>
						<div className="catalog-filtration__brand-input-wrap">
							<input type="checkbox" className="catalog-filtration__brand-input" value="Bardot" onChange={changeBrand} />
							<p className="catalog-filtration__brand-input-name">bardot</p>
						</div>
						<div className="catalog-filtration__brand-input-wrap">
							<input type="checkbox" className="catalog-filtration__brand-input" value="Alfani" onChange={changeBrand} />
							<p className="catalog-filtration__brand-input-name">alfani</p>
						</div>
						<div className="catalog-filtration__brand-input-wrap">
							<input type="checkbox" className="catalog-filtration__brand-input" value="Cece" onChange={changeBrand} />
							<p className="catalog-filtration__brand-input-name">cece</p>
						</div>
						<div className="catalog-filtration__brand-input-wrap">
							<input type="checkbox" className="catalog-filtration__brand-input" value="Donna Ricco" onChange={changeBrand} />
							<p className="catalog-filtration__brand-input-name">donna ricco</p>
						</div>
					</form>
				</div>
				<div className="catalog-filtration__size">
					...
					<form action="" className="catalog-filtration__size-form">
						<button className="catalog-filtration__size-button" onClick={changeSize}>
							osfa
						</button>
						<button className="catalog-filtration__size-button" onClick={changeSize}>
							w26
				...
				<div className="catalog-filtration__dress-length">
					...
					<form action="" className="catalog-filtration__dress-length-form">
						<div className="catalog-filtration__dress-length-input-wrap">
							<input type="checkbox" className="catalog-filtration__dress-length-input" onChange={changeDressLength} value="short" />
							<p className="catalog-filtration__dress-length-name">short</p>
						</div>
						<div className="catalog-filtration__dress-length-input-wrap">
							<input type="checkbox" className="catalog-filtration__dress-length-input" onChange={changeDressLength} value="knee length" />
							<p className="catalog-filtration__dress-length-name">knee length</p>
						</div>
						<div className="catalog-filtration__dress-length-input-wrap">
							<input type="checkbox" className="catalog-filtration__dress-length-input" onChange={changeDressLength} value="hight low" />
							<p className="catalog-filtration__dress-length-name">hight low</p>
						</div>
						<div className="catalog-filtration__dress-length-input-wrap">
							<input type="checkbox" className="catalog-filtration__dress-length-input" onChange={changeDressLength} value="long" />
							<p className="catalog-filtration__dress-length-name">long</p>
						</div>
						<div className="catalog-filtration__dress-length-input-wrap">
							<input type="checkbox" className="catalog-filtration__dress-length-input" onChange={changeDressLength} value="midi" />
				...
				<div className="catalog-filtration__color">
					...
					<form action="" className="catalog-filtration__form-color">
						<button style={{ backgroundColor: "#292a2d" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#292a2d"}></button>
						<button style={{ backgroundColor: "#f3ece2" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#f3ece2"}></button>
						<button style={{ backgroundColor: "#24426a" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#24426a"}></button>
						<button style={{ backgroundColor: "#292a2d" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#292a2d"}></button>
						<button style={{ backgroundColor: "#666689" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#666689"}></button>
						<button style={{ backgroundColor: "#c2beb6" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#c2beb6"}></button>
						<button style={{ backgroundColor: "#aaaba7" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#aaaba7"}></button>
						<button style={{ backgroundColor: "#971e34" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#971e34"}></button>
						<button style={{ backgroundColor: "#cba13e" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#cba13e"}></button>
						<button style={{ backgroundColor: "#73513c" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#73513c"}></button>
						<button style={{ backgroundColor: "#dab1b1" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#dab1b1"}></button>
						<button style={{ backgroundColor: "#2b9fa7" }} className="catalog-filtration__form-color-btn" onClick={changeColor} value={"#2b9fa7"}></button>
					</form>
				</div>
				<div className="catalog-filtration__price">
					...
					<button className="catalog-filtration__apply" onClick={handleApplyFilters}>
						Apply
					</button>
				</div>
				<div className="catalog-filtration__about-dresses">
					<h2 className="catalog-filtration__about-dresses-title">About Dresses</h2>
					<p className="catalog-filtration__about-dresses-text">
						Every day we’re gonna be dropping the latest trends to help you nail every Summer sitch. Whether it’s a graduation, your mate's wedding, or just a cute day at the races with
						the gals, our occasion dresses have got you covered. Not looking for something fancy? No stress. We’ve got day dresses for days (aka bodycon dresses, t-shirt dresses, oversized
						shirt dresses).
					</p>
				</div>
			</section>
