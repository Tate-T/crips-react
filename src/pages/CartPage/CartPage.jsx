								...
								<ul className={styles.cart__phone__list}>
									<li className={styles.cart__phone__item}>
										<div className={styles.cart__phone__content}>
											<img src="" alt="Dress" className={styles.cart__phone__image} />
											<div className={styles.cart__phone__info}>
												<h4 className={styles.cart__phone__title}>Angels malu zip jeans slim black used</h4>
												<p className={styles.cart__phone__number}>
													<span className={styles.cart__phone__desc}>Size: </span>
													W31/L34
												</p>
												<p className={styles.cart__phone__number}>
													<span className={styles.cart__phone__desc}>Art.No.: </span>
													434536465
												</p>
												<p className={styles.cart__phone__color}>
													Color:
													<div className={styles.cart__phone__square}>
														<div className={styles.cart__phone__color}></div>
													</div>
												</p>
											</div>
										...
										<div className={styles.cart__phone__amount}>
											<div className={styles.cart__phone__quantity}>
												...
												<div className={styles.cart__phone__rectangle}>
													<button className={styles.cart__phone__subtract} type="button">
														<div className={styles.cart__phone__minus}></div>
													</button>
													<p>1</p>
													<button type="button" className={styles.cart__phone__add}>
											...
											<div className={styles.cart__phone__info}>
												...
												<p className={styles.cart__phone__color}>
													...
													<span className={styles.cart__phone__square}>
														<span className={styles.cart__phone__color}></span>
													</span>
												</p>
											</div>
											<div className={styles.cart__phone__actions}>
							...
							<div className={styles.cart__products}>
								...
								<ul className={styles.cart__list}>
									<li className={styles.cart__item}>
										<img src="url" alt="Dress" className={styles.cart__item__image} />
										...
										<div className={styles.cart__item__quantity__rectangle}>
											<button className={styles.cart__item__quantity__subtract} type="button">
												<div className={styles.cart__item__quantity__minus}></div>
											</button>
											<p>1</p>
											<button type="button" className={styles.cart__item__quantity__add}>
							...
							<form action="" className={styles.cart__form}>
								<div className={styles.cart__details}>
									...
									<div className={styles.cart__details__wrapper}>
										<input className={styles.cart__details__input} type="text" placeholder="Enter discount code" />
									...
									<p className={styles.cart__details__subtitle}>Enter your destination to get a shipping estimate.</p>
									<div className={styles.cart__details__shipping}>
										<div className={styles.cart__details__information}>
											<p className={styles.cart__details__info}>
												Country
												<span className={styles.cart__details__info__red}>*</span>
											</p>
									...
									<div>
										<input type="radio" name="shipping" value="flat" id="table" />
										<label for="flat" className={styles.cart__details__taxchoice}>
											Fixed 5.00 EUR
										</label>
									</div>
									...
									<div>
										...
										<label for="table" className={styles.cart__details__taxchoice}>
