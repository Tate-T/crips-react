...
export const OrderSummaryModal = ({ modalIsOpened, closeModal, children }) => {
  const [showItems, setShowItems] = useState(false);

  return (
    modalIsOpened && (
      <div className={s.order__backdrop} onClick={closeModal}>
        <div className={s.order__modalWrap} onClick={(e) => e.stopPropagation()}>
          <div className={s.order__wrap}>
            <h2 className={s.order__title}>Order Summary</h2>
            <img className={s.order__close} src={close} onClick={closeModal} alt="close" />
            <div className={s.order__wrapper}>
              ...
              <div className={s.order__que} onClick={() => setShowItems((prev) => !prev)}>
